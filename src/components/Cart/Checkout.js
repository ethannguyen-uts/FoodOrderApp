...
const Checkout = (props) => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredPostalCode = portalCodeInputRef.current.value;
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={postalCodeControlClasses}>
        ...
        <input ref={portalCodeInputRef} type="text" id="postal" />
        {!formInputValidity.postalCode && (
          <p>Please entered a valid postal code (5 characters)</p>
        )}
      </div>
